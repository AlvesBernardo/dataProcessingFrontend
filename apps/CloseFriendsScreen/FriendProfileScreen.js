  ...
  return (
    <SafeAreaView style={myStyles.container}>
      ...
      <View style={myStyles.profileContainer}>
        ...
        <View style={myStyles.textInputs}>
          <Text>Upcoming: Gaming Table</Text>
        </View>

        <View>
          <TouchableHighlight style={myStyles.button} onPress={backToCloseFriends}>
            <Text style={myStyles.buttonText}>Unfollow</Text>
          </TouchableHighlight>
        </View>
      </View>
    </SafeAreaView>
